...
جدول زیر نتیجه اجرای مسیریابی روی داده‌های آزمایشی چندلایه‌ای با
الگوی باد واقعی (باد از شمال، حرکت شمال‌شرقی) است:

| لایه (متر) | سرعت باد (م/ث) | مسافت (km) | زمان سفر (ساعت) | هزینه کل | بهترین؟ |
|-----------|----------------|------------|-----------------|---------|---------|
| ۵۰۰ | ۱۵ | ۲۱.۱۴ | ۰.۱۸۱۱ | ۰.۱۸۱۱ | ❌ |
| ۱۰۰۰ | ۵ | ۲۱.۱۴ | ۰.۱۰۸۴ | ۰.۱۰۸۴ | ✅ |
...
کمتری (حدود ۴۰٪ بهتر) تولید می‌کند.
